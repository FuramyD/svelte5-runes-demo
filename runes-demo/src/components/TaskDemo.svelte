<script lang="ts">
	import { initTaskStore } from '../stores/tasks.svelte';
...
<div class="task-demo">
	<h2>Менеджер задач (Стор на рунах)</h2>
	
	<p class="description">
		Этот пример демонстрирует использование глобального/контекстного состояния (стора) на основе рун 
		<code>$state</code> и <code>$derived</code> (в виде геттеров класса), изолированного с помощью Context API.
	</p>
